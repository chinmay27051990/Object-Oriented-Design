...
public:
  ...
  ClientHandler(BlockingQueue<Message>* pQ, const std::string& recPath, const std::string& name = "clientHandler") : pQ_(pQ), saveFilePath(recPath), clientHandlerName(name)
  {
